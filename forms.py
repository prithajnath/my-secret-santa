...
class SignUpForm(FlaskForm):
    ...
    first_name = StringField('first_name', validators=[InputRequired(), Length(min=2, max=150)])
    last_name = StringField('last_name', validators=[InputRequired(), Length(min=2, max=150)])
